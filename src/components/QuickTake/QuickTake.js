                    ...
                    <Col xs="12" md={{size:9, offset: 2}} lg={{size: 5, offset: 2}} className="text-center">
                        <Row>
                            <div>
                                ...
                                <br />
                                <br />
                                <h6 className="text-left"> I have recently joined Lisa Giocomo's Lab. We study navigation. Before this, I was extreemly lucky to work with Marty Usrey, Henry Alitto, and Krishna Shenoy.</h6>
                                <br />
